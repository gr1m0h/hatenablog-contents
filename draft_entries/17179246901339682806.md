...
macOSではHomebrewを使用してインストールできます。また、asdf-vmやmiseを使用してインストールすることもできます。
...
ちなみにasdf-vmやmiseがk6インストール時にバックエンドで利用しているk6のasdf-pluginは私が作成したものです。

[https://github.com/gr1m0h/asdf-k6:embed:cite]

このプラグインは2019年に作成したものですが、今でも使われているのは感慨深いものがあります。
